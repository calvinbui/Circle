 ...
 */
public final class LeaderboardAdapter extends BaseAdapter implements RemoveListener, DropListener {
    private int[] mIds;
    private int[] mLayouts;
    private LayoutInflater mInflater;
    private ArrayList<String> mContent;

    public LeaderboardAdapter(Context context, ArrayList<String> content) {
        init(context,new int[]{android.R.layout.simple_list_item_1},new int[]{android.R.id.text1}, content);
    }

    public LeaderboardAdapter(Context context, int[] itemLayouts, int[] itemIDs, ArrayList<String> content) {
